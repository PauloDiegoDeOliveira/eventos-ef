...
{
    public class PutReservaValidator : AbstractValidator<PutReservaDto>
    {
        ...
        public PutReservaValidator(IReservaApplication reservaApplication, IEventoApplication eventoApplication,
