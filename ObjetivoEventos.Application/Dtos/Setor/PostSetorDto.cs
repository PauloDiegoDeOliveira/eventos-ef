...
namespace ObjetivoEventos.Application.Dtos.Setor
{
    ...
    public class PostSetorDto
    {
        ...
        /// Mesas
        /// </summary>
        [Display(Name = "Mesas do setor.")]
        public List<ReferenciaMesaDto> Mesas { get; set; }

        /// <summary>
        /// Cadeiras
        /// </summary>
        [Display(Name = "Cadeiras do setor.")]
        [Required(ErrorMessage = "O campo cadeiras do setor é obrigatório.")]
